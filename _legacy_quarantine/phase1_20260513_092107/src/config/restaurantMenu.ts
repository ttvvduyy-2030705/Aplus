...
export const RESTAURANT_MENU_ENV_CONFIG: RestaurantMenuEnvironmentConfig = {
  ...
  apiTimeoutMs: 15000,
  apiRetryCount: 1,
  defaultRestaurantId: 'local_demo_restaurant', // API seed example: 'haidilao_demo'
  // Local demo token: 'qr_local_main_01'. API seed examples: 'qr_haidilao_main_01', 'qr_aplus_main_01'
  defaultTableToken: 'qr_local_main_01',
};
